      ...
      <section className="flex flex-col gap-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="max-w-2xl text-ink-soft">
            Cada libro se representa como un vector de 384 dimensiones generado
            desde su título, autor, género y sinopsis. Las recomendaciones salen
            de comparar tu historial contra el catálogo por similitud coseno,
            ponderando por cómo puntuaste cada libro.
          </p>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <Card tone="brand" className="text-center">
            ...
            <p className="text-xs font-bold">recall@5 · n = 54</p>
          </Card>
          <Card className="text-center">
            <p className="font-display text-title">0,18</p>
            <p className="text-xs font-bold">percentil promedio</p>
          </Card>
          <Card className="text-center">
            <p className="font-display text-title">2,3×</p>
            <p className="text-xs font-bold">sobre el baseline inicial</p>
          </Card>
        </div>

        <Card tone="sky" className="text-sm">
          <p>
            Medido con un harness propio de evaluación <em>leave-one-out</em>{" "}
            sobre 54 casos (IC 95%: 0,42–0,68). Los usuarios de demostración son
            sintéticos y con gustos coherentes a propósito, así que{" "}
      ...
      <section className="flex flex-col gap-4">
        ...
        <Card tone="muted" className="flex flex-col gap-3 text-sm">
          ...
          <p>
            ...
            agregar libros, y esos libros afectan las recomendaciones de todos.
          </p>
          <div>
            <a
